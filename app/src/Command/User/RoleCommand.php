...
use App\Model\User\Entity\Role as UserRole;
...
class RoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $command->role = $helper->ask($input, $output, new ChoiceQuestion('Role: ', UserRole::choices(), 0));
        ...
        $output->writeln('<info>Role changed</info>');
        return 0;
    }
}
