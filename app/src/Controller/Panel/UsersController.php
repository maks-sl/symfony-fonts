...
use App\Model\User\UseCase\Confirm;
...
class UsersController extends AbstractController
{
    ...
    public function create(Request $request, Create\Handler $handler): Response
    {
        ...
        return $this->render('panel/users/create.html.twig', [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function role(User $user, Request $request, Role\Handler $handler): Response
    {
        ...
        return $this->render('panel/users/role.html.twig', [
            'user' => $user,
            'form' => $form->createView(),
        ]);
    }
     ...
     * @return Response
     */
    public function confirm(User $user, Request $request, Confirm\Handler $handler): Response
    {
        if (!$this->isCsrfTokenValid('confirm', $request->request->get('token'))) {
            return $this->redirectToRoute('users.show', ['id' => $user->getId()]);
        }

        $command = new Confirm\Command($user->getId()->getValue());
    ...
    {
        return $this->render('panel/users/show.html.twig', compact('user'));
    }
}
